...
symptoms = {
    ...
    "G48": "Bintik hitam dalam penglihatan"
}
...
rules = {
    ...
    "P04": [("G04", 0.6), ("G05", 0.4), ("G06", 0.4), ("G10", 0.4), ("G11", 0.8), ("G12", 0.4), ("G15", 0.4), ("G16", 0.6), ("G19", 0.2)],
    "P05": [("G04", 0.4), ("G05", 0.4), ("G06", 0.2), ("G10", 0.4), ("G01", 0.6), ("G21", 0.4), ("G22", 0.8), ("G23", 0.8), ("G24", 0.4), ("G25", 0.2), ("G26", 0.8)],
    ...
    "P15": [("G31", 0.2), ("G46", 0.9), ("G47", 0.6), ("G48", 0.6)]
}
